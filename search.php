...
<br><br>
   ...
   <?php 
     ...
     if(isset($_GET['search'])){
        ...
        $sql = "SELECT * FROM application WHERE Name,Platform LIKE '%$searchKey%'   ";
     }else
 ...
 <center>  
   <form action="" method="GET"> 
     <div class="col-md-8">
        ...
        <button type="btn" class="btn btn-primary btn-lg btn-block">Search</button>
 ...
 <br><br> 
   	...
   	<div class="container">
		...
		if(isset($_GET['search'])){
		$searchKey = $_GET['search'];	
		$query = $db_handle->runQuery("SELECT * FROM application WHERE Name LIKE '%$searchKey%' OR Platform LIKE '%$searchKey%' ORDER BY id DESC");
						...
						<div class="col-md-4">
							<div class="car-wrap rounded ">
								...
								<div class="text">
                                    ...
                                    <a href="includes/download.php?file_id=<?php echo $query[$key]["id"];?>&page=games" class="btn btn-secondary py-2 ml-1">Details</a>
