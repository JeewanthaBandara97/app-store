...
<br>
   	...
   	<div class="container">
		...
		<?php
		$query = $db_handle->runQuery("SELECT * FROM application WHERE Type='Game' ORDER BY id DESC");
		if (! empty($query)) {
						...
						<div class="col-md-4">
							<div class="car-wrap rounded ">
								...
								<div class="text">
                                    ...
                                    <a href="details.php?file_id=<?php echo $query[$key]["id"];?>&page=games" class="btn btn-secondary py-2 ml-1">Details</a>
