...
<form name="insert-form" id="contact-form"  action="banner-upload4.php" method="POST" enctype="multipart/form-data">     
	<br>
		<?php $id=intval($_GET['id']); ?>
					...
					<center>					 
					  <img src="../../bannerimg/<?php echo $resalt['Image4']; ?>" width="300" height="200" style="border:solid 1px #000" class="input">
					</center>					
