                    ...
                    <div class="col-lg-12 col-md-12">
                        ...
                        <table class="table table-striped table-bordered table-hover" width="100%" id="table-id">
                            ...
                            <tbody>
										...
										$qury=mysqli_query($con,"SELECT * FROM application WHERE Type='App' ");
                                ...
                                <tr>
                                    ...
                                    <td align="center">	
                                         <a href="includes/deleteapp.php?id=<?php echo $resalt['id']; ?>&File=<?php echo $resalt['File']; ?>&appid=<?php echo $resalt['id']; ?>">Remove</a>									
								    </td>									
                                </tr>                               					
                            </tbody>
										<?php
