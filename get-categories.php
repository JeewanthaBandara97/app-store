...
<header id="header">
	...
	<br>
   	...
   	<div class="container">
	        ...
	        <center>Showing  <?php echo $Category ; ?> Category     </center>
		...
		<?php
		$query = $db_handle->runQuery("SELECT * FROM application WHERE Type='$Type' AND Category='$Category' ORDER BY id DESC");
		if (! empty($query)) {
						...
						<div class="col-md-4">
							<div class="car-wrap rounded ">
								...
								<div class="text">
                                    ...
                                    <a href="details.php?file_id=<?php echo $query[$key]["id"];?>&page=categories" class="btn btn-secondary py-2 ml-1">Details</a>
